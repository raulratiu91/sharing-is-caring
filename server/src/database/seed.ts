...
const sampleVolunteers = [
  {
    ...
    volunteerInfo: {
      ...
      experience:
        'Volunteer with senior center for 3 years. Experience with technology training and companionship.',
  ...
  },
  {
    ...
    volunteerInfo: {
      ...
      experience:
        'Handyman with 10+ years experience. Love helping elderly with home maintenance.',
      backgroundCheck: true,
      rating: 4.9,
      totalHelpCount: 18,
    },
  ...
  },
  {
    ...
    volunteerInfo: {
      ...
      experience:
        'Former teacher, now freelancer. Passionate about cross-cultural connections.',
      backgroundCheck: true,
      rating: 4.7,
      totalHelpCount: 15,
    },
...
async function seedVolunteers() {
  ...
  for (const volunteerData of sampleVolunteers) {
    try {
      ...
      logger.err(
        `✗ Failed to create volunteer profile: ${volunteerData.name}`,
        true
      );
      logger.err(error as Error, true);
    }
...
async function displayStats() {
  ...
  const volunteersCount = await UserEnhanced.countDocuments({
    userType: 'volunteer',
  });
